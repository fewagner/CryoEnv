...
# for double tes: put to time=480
...
PYTHON_OPTIONS=" -u "
CMD_ARGUMENTS=" --version ${idx} --detector ${name} --rnd_seed ${idx} --alt_seed 10000 --scale 0.2 --lr 3e-4  --batch_size 16  --gamma 0.9  --gradient_steps 20"  # --double_tes
